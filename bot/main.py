...
EVENT_PROGRAM_TEXT = (
    ...
    "📍 Papa Moscow Club, Москва\n"
    "📅 16 марта, 18:00–22:30\n\n"
    "Вечер объединит профессионалов индустрии событий: владельцев ивент-агентств, режиссёров, организаторов мероприятий и предпринимателей из Москвы, Санкт-Петербурга, Казани и Дубая.\n\n"
    "Концепция события — «Драгоценные камни»: каждый гость — уникальная грань индустрии, создающая общее сияние вечера.\n\n"
    "Гостей ждёт насыщенная программа: шоу-перформансы, живые музыкальные выступления, гастрономические станции, авторские коктейли, нетворкинг и презентации трендов 2026 в show-production, catering и event-локациях.\n\n"
    "Программа вечера\n\n"
    "18:00 — Сбор гостей, регистрация и welcome\n"
    "19:00 — Музыкальный welcome, живые перформансы и инсталляции\n"
    "20:00 — Открытие основной программы и приветствие организаторов\n"
    "20:30 — Шоу-блок и выступления артистов\n"
    "21:15 — Розыгрыш подарков от партнёров\n"
    "21:40 — Финальные перформансы\n"
    "22:00–22:30 — DJ-сет и завершающий dance-перформанс от Артемия Золотова и команды «Новый балет»"
)
...
До встречи на мероприятии."""
    ...
    MESSAGE_KEY_MY_TICKET: (
        ...
        "Локация: Papa Moscow Club\n"
        "Дата и время: 16 марта, 18:00–22:30\n\n"
